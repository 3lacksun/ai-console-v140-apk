...
const transitions={DRAFT:['QUEUED','CANCELLED'],QUEUED:['SENDING','CANCELLED'],SENDING:['SENT','FAILED','CANCELLED'],FAILED:['QUEUED','CANCELLED'],SENT:[],CANCELLED:[]};
...
export const retryTurn=(q,id,now=Date.now())=>(q||[]).map(e=>e.id===id?transitionQueuedTurn(e,QueueStatus.QUEUED,now):e);
